...
# The board's text and title faces are OFL-licensed subsets (their licence
# texts sit beside them); they are the one font family this tree may carry.
# The backdrop is baked from the client and is NOT
# tracked (see .gitignore).
FONT_ALLOW_DIR = os.path.join("services", "boardart", "fmo")
FONT_ALLOW_PREFIX = "fmo-"
